...
public class Config {
    ...
    private static void createTables() {
        try {
            ...
            sql.append("CREATE TABLE IF NOT EXISTS authors (author_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,");
            sql.append("name varchar(100) not null);");
            statement.executeUpdate(sql.toString());
            sql.setLength(0);
            sql.append("CREATE TABLE IF NOT EXISTS books (book_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ");
            sql.append("title varchar(100) not null, author integer not null, quantity integer DEFAULT 0, ");
            ...
            statement.executeUpdate(sql.toString());
            sql.setLength(0);
            sql.append("CREATE TABLE IF NOT EXISTS users (user_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ");
            sql.append("login varchar(50) not null, password varchar(50) not null, name varchar(100) not null, access varchar(20) not null, ");
            ...
            statement.executeUpdate(sql.toString());
            sql.setLength(0);
            sql.append("CREATE TABLE IF NOT EXISTS orders (order_id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, user_id integer not null, ");
